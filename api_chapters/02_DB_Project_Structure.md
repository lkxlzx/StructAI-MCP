...
|---|---|---|---|
| `PJCF` | `CRUD /db/PJCF` | Project Information | `Assign` |
| `UNIT` | `GET/PUT /db/UNIT` | Unit System | `Assign（仅 GET/PUT）` |
| `STYP` | `GET/PUT /db/STYP` | Structure Type | `Assign（仅 GET/PUT）` |
| `STYP-M1` | `CRUD /db/STYP-M1` | Structure Type Hyper-S | `Assign` |
| `GRUP` | `CRUD /db/GRUP` | Structure Group | `Assign` |
| `BNGR` | `CRUD /db/BNGR` | Boundary Group | `Assign` |
| `LDGR` | `CRUD /db/LDGR` | Load Group | `Assign` |
| `TDGR` | `CRUD /db/TDGR` | Tendon Group | `Assign` |
| `NPLN` | `CRUD /db/NPLN` | Named Plane | `Assign` |
| `CO_M` | `CRUD /db/CO_M` | Material Color | `Assign` |
| `CO_S` | `CRUD /db/CO_S` | Section Color | `Assign` |
| `CO_T` | `CRUD /db/CO_T` | Thickness Color | `Assign` |
| `CO_F` | `CRUD /db/CO_F` | Floor Load Color | `Assign` |
| `SPAN` | `CRUD /db/SPAN` | Span Information | `Assign` |
| `STOR` | `CRUD /db/STOR` | Story Data | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/02_DB_Project_Structure.md
```
