# DB Load Combinations / Results Setup
...
|---|---|---|---|
| `LCOM-GEN` | `CRUD /db/LCOM-GEN` | General load combinations | `Assign` |
| `LCOM-CONC` | `CRUD /db/LCOM-CONC` | Concrete design combinations | `Assign` |
| `LCOM-STEEL` | `CRUD /db/LCOM-STEEL` | Steel design combinations | `Assign` |
| `LCOM-SRC` | `CRUD /db/LCOM-SRC` | SRC design combinations | `Assign` |
| `LCOM-STLCOMP` | `CRUD /db/LCOM-STLCOMP` | Composite steel girder combinations | `Assign` |
| `LCOM-SEISMIC` | `CRUD /db/LCOM-SEISMIC` | Seismic combinations | `Assign` |
| `CUTL` | `CRUD /db/CUTL` | Cutting line | `Assign` |
| `CLWP` | `CRUD /db/CLWP` | Plate cutting-line diagram | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/13_DB_Load_Combinations.md
```
