...
|---|---|---|---|
| `DCON` | `CRUD /db/DCON` | RC design code | `Assign` |
| `DSTL` | `CRUD /db/DSTL` | Steel design code | `Assign` |
| `RCHK` | `CRUD /db/RCHK` | Rebar checking input | `Assign` |
| `LENG` | `CRUD /db/LENG` | Unbraced length | `Assign` |
| `MEMB` | `CRUD /db/MEMB` | Member assignment | `Assign` |
| `DCTL` | `CRUD /db/DCTL` | Frame definition | `Assign` |
| `LTSR` | `CRUD /db/LTSR` | Slenderness limit | `Assign` |
| `MBTP` | `CRUD /db/MBTP` | Member type | `Assign` |
| `WMAK` | `CRUD /db/WMAK` | Wall mark | `Assign` |
| `REBB` | `CRUD /db/REBB` | Beam rebar | `Assign` |
| `REBC` | `CRUD /db/REBC` | Column rebar | `Assign` |
| `REBW` | `CRUD /db/REBW` | Wall rebar | `Assign` |
| `REBR` | `CRUD /db/REBR` | Brace rebar | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/24_DB_Design.md
```
