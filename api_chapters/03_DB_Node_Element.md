...
| `ELEM` | `POST/GET/PUT/DELETE /db/ELEM` | Element definition | `Assign` |
| `SKEW` | `POST/GET/PUT/DELETE /db/SKEW` | Node local axis | `Assign` |
| `MADO` | `POST/GET/PUT/DELETE /db/MADO` | Domain | `Assign` |
| `SBDO` | `POST/GET/PUT/DELETE /db/SBDO` | Sub-domain | `Assign` |
| `DOEL` | `POST/GET/PUT/DELETE /db/DOEL` | Domain-element relation | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/03_DB_Node_Element.md
```
