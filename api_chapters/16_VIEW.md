...
|---|---|---|---|
| `SELECT` | `POST /view/SELECT` | Select objects | `Argument` |
| `CAPTURE` | `POST /view/CAPTURE` | Capture image | `Argument` |
| `PRECAPTURE` | `POST /view/PRECAPTURE` | Dialog capture | `Argument` |
| `ANGLE` | `POST /view/ANGLE` | Viewpoint | `Argument` |
| `ACTIVE` | `POST /view/ACTIVE` | Active display | `Argument` |
| `DISPLAY` | `POST /view/DISPLAY` | Display control | `Argument` |
| `RESULTGRAPHIC` | `POST /view/RESULTGRAPHIC` | Result display | `Argument` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/16_VIEW.md
```
