...
|---|---|---|---|
| `GSBG` | `CRUD /db/GSBG` | Bridge girder diagram | `Assign` |
| `GCMB` | `CRUD /db/GCMB` | General camber control | `Assign` |
| `CAMB` | `CRUD /db/CAMB` | FCM camber control | `Assign` |
| `ULFC` | `CRUD /db/ULFC` | Cable control constraints | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/17_DB_Bridge.md
```
