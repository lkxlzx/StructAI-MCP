...
|---|---|---|---|
| `SPFC` | `CRUD /db/SPFC` | Response spectrum functions | `Assign` |
| `SPLC` | `CRUD /db/SPLC` | Response spectrum load cases | `Assign` |
| `THGC` | `CRUD /db/THGC` | Time history global control | `Assign` |
| `THGC-M1` | `CRUD /db/THGC-M1` | Hyper-S time history global control | `Assign` |
| `THOO-M1` | `CRUD /db/THOO-M1` | Hyper-S time history output option | `Assign` |
| `THIS` | `CRUD /db/THIS` | Time history load cases | `Assign` |
| `THIS-M1` | `CRUD /db/THIS-M1` | Hyper-S time history load cases | `Assign` |
| `THFC` | `CRUD /db/THFC` | Time history functions | `Assign` |
| `THGA` | `CRUD /db/THGA` | Ground acceleration | `Assign` |
| `THNL` | `CRUD /db/THNL` | Dynamic nodal loads | `Assign` |
| `THSL` | `CRUD /db/THSL` | Time-varying static loads | `Assign` |
| `THMS` | `CRUD /db/THMS` | Multiple support excitation | `Assign` |
...
```text
https://github.com/Dennis5882/MIDAS-API/blob/main/docs/manual/09_DB_Dynamic_Loads.md
```
