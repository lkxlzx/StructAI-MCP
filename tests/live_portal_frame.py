...
from midas_mcp.results import result_summary  # noqa: E402
...
def run(clear=False):
    ...
    try:
        if clear:
            print("clear:", clear_document(s, CLEAR_ORDER) or "(没有需要删除的记录)",
                  flush=True)
